...
from .validators import f_name_validator, validate_image_mimetype

class Student(models.Model):
    f_name = models.CharField(max_length=50, verbose_name="الاسم الأول", validators=[f_name_validator]) # HW - تنفيذ التحقق من الحرف الاول
    ...
    image = models.ImageField(
        ...
        validators=[validate_image_mimetype] # HW- تنفيذ التحقق1
    )
